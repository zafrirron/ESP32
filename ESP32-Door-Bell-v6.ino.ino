...
// Global definitions
//Wifi  Definitions
const char* ssid     = "NAFTALY";
const char* password = "05247199572017";
IPAddress local_IP(10, 0, 0, 70);  //Set fixed local IP
...
//Sonos server data
const char* SonosHost = "10.0.0.155";  //Sonos Server IP
const uint16_t SonosPort = 5005;  //Sonos service port
#define OFFICE_Ta_Da "/office/clip/Ta-Da.mp3"  //optional clips see Sonos API
#define HOME_CHURCH "/clipall/church-3.mp3"    //another optional clips see Sonos API
const String SoundUri = OFFICE_Ta_Da;  //Selected clip to play
...
const char* LoggerHost = "10.0.0.155";  //Sonos Server IP
const uint16_t LoggerPort = 8000;  //Sonos service port
